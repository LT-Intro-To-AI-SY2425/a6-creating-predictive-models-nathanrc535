...
writeupInfo = [[34, 56000, 1]]
scaledInfo= scaler.transform(writeupInfo)
newPrediction = model.predict(scaledInfo)
print("34 y.o female with a salary of 56000:", "Will buy a SUV" if newPrediction[0] == 1 else "she Will not buy it.")
